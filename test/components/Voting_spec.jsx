...
describe('Voting', () => {
  ...
  // if we gave a mutable array, then caused mutation inside array, should not be re-rendered
  ...
  // explicitly set a new immutable list in the props to have change reflected in UI
